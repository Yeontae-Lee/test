...
/* 			transform: rotate(-90deg); */
    ...
    <script type="text/javascript">
    	...
    	function initRoulette(){
        	...
        	document.getElementById("roulette").addEventListener("animationstart", function(e) {
        	    console.log("시작");
        	}, false);

        	document.getElementById("roulette").addEventListener("animationend", function(e) {
        	    console.log("종료");
        	}, false);
    	}
    	...
    	function openAddPop(){
    		document.getElementById("btnArea").innerHTML = 
    			'<input type="button" id="cancelBtn" value="취소" onclick="triggerAddPop();">'
...
// 	   	}
    	...
    	function openUpdatePop(index){
    		document.getElementById("btnArea").innerHTML = 
    		 ...
    		 '<input type="button" id="saveBtn" value="저장" onclick="clickUpdateBtn('+index+');">';
    	...
    	function setRoulettePanel(){
    		...
    		while ( i < panelArrSize){
    			...
    			panelInfoTbody.push("<td><button onclick=\"openUpdatePop('"+i+"');\">바꾸기</button></td></tr>");
    			
    		}
    		panelInfoTbody.push("<tr><td colspan=\"2\"><button class=\"addBtn\" onclick=\"openAddPop('add');\">추가</button></td></tr>");
//     		panelInfoTbody.push("<tr><td colspan=\"2\"><button class=\"delBtn\" onlclick=\"openDepPop('del');\">삭제</button></td></tr>");
    ...
    <body>
    	<div class="container"> 
    		...
    		<div class="eq" id="roulette">
				<div class="panel panel_1" style="background: #00D8FF;"><strong class="txt" >텍스트</strong></div>
				<div class="panel panel_2" style="background: #F2CB61;"><strong class="txt">텍스트</strong></div>
				<div class="panel panel_3" style="background: #FAECC5;"><strong class="txt">텍스트</strong></div>
				<div class="panel panel_4" style="background: #665C00;"><strong class="txt">텍스트</strong></div>
				...
				<table>
					...
					<tr>
						<td>
							...
							<label for="colorTypeBg">룰렛배경색</label>
							<br/>
							<input type="radio" id="colorTypeFont" name="colorType" value="font">
							<label for="colorTypeFont">텍스트글자색</label>
						</td>
						<td>
